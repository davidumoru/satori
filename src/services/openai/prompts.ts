...
export function createRoadmapPrompt(formData: RoadmapFormData): string {
  return `
...
7. Each node ID should be unique and descriptive
8. Resources should include a mix of different types when appropriate
`;
}